...
/**
 * Interface para operações de acesso a dados relacionadas aos registros de movimentação de produtos.
 */
public interface RegistroDao {
     ...
     * 
     * @param reg o objeto {@link Registro} que representa a movimentação a ser adicionada.
     */
     ...
     * 
     * @param reg o objeto {@link Registro} que representa a movimentação a ser removida.
     */
