...
/**
 * Interface DAO para operações de acesso e manipulação dos dados da entidade Produto.
 * Define os métodos para CRUD, ajustes de preços, atualização de categorias e geração de relatórios.
 */
public interface ProdutoDao {
     ...
     * @return o produto correspondente ao id informado, ou null se não encontrado
     */
    ...
    /**
     * Atualiza o nome da categoria de todos os produtos que possuem uma categoria específica.
     * 
     ...
     * @param categoria o nome da categoria cujos produtos terão o preço aumentado
     */
     ...
     * @param categoria o nome da categoria cujos produtos terão o preço reduzido
     */
    ...
    /**
     * Gera relatório de lista de preços de produtos abaixo da quantidade mínima, no formato Excel.
     * 
     * @param caminhoArquivoSaidaExcel caminho onde o arquivo Excel será salvo
     * @param nomePlanilha nome da planilha dentro do arquivo Excel
     */
    ...
    /**
     * Gera relatório de lista de preços de produtos acima da quantidade máxima, no formato Excel.
     * 
     * @param caminhoArquivoSaidaExcel caminho onde o arquivo Excel será salvo
     * @param nomePlanilha nome da planilha dentro do arquivo Excel
     */
    ...
    /**
     * Gera relatório de lista de preços de produtos abaixo da quantidade mínima, no formato DOC.
     * 
     * @param caminhoArquivoSaidaDoc caminho onde o arquivo DOC será salvo
     * @param nomeArquivoDoc nome do arquivo DOC
     */
    ...
    /**
     * Gera relatório de lista de preços de produtos acima da quantidade máxima, no formato DOC.
     * 
     * @param caminhoArquivoSaidaDoc caminho onde o arquivo DOC será salvo
     * @param nomeArquivoDoc nome do arquivo DOC
     */
    ...
    /**
     * Gera relatório de lista de preços de produtos abaixo da quantidade mínima, no formato PDF.
     * 
    ...
    /**
     * Gera relatório de lista de preços de produtos acima da quantidade máxima, no formato PDF.
     * 
     * @param caminnhoArquivoSaidaPDF caminho onde o arquivo PDF será salvo
     * @param nomeArquivoPDF nome do arquivo PDF
     */
